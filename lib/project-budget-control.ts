...
export const ALLOCATED_BUDGET_ITEMS: BudgetItemDefinition[] = [
  ...
  { code: "104", field: "งบไม่เกินซ่อมรถ", label: "104. ซ่อมรถ", group: "หมวดงานเตรียมดิน & โลจิสติกส์", categoryType: "ค่าของ", icon: "🚗", matchKeywords: ["ซ่อมรถ", "104", "อะไหล่", "ยาง", "ถ่ายน้ำมันเครื่อง", "5.ซ่อมรถ"] },
