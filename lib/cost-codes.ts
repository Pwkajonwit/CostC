...
export function getCostCodeBudgetField(codeOrName: string): string {
  ...
  if (clean.startsWith("103") || clean.includes("เสาเข็ม")) return "งบไม่เกินปูนทรายหิน";
  ...
  if (clean.startsWith("109") || clean.includes("ก่อฉาบ") || clean.includes("ปูน")) return "งบไม่เกินปูนทรายหิน";
  ...
  if (clean.startsWith("118") || clean.startsWith("119") || clean.startsWith("122") || clean.includes("บิวอิน") || clean.includes("เฟอร์นิเจอร์") || clean.includes("นั่งร้าน") || clean.includes("ตบแต่งภายใน")) return "งบไม่เกินบิวอิน";
  if (clean.startsWith("120") || clean.includes("ภูมิทัศน์")) return "งบไม่เกินเตรียมงาน";
  if (clean.startsWith("121") || clean.includes("แก้ไขเก็บงาน") || clean.includes("วัสดุอื่นๆ")) return "งบไม่เกินวัสดุอื่นๆ";
