...
export const VIEW_COLUMNS: Record<string, string[]> = {
  ...
  "4. ร้านค้า": ["id_store", "ชื่อร้านค้า", "ชื่อเต็ม", "เครดิตจ่าย", "เลขบัญชี", "ธนาคาร", "เบอร์โทร", "ที่อยู่", "เลขที่ผู้เสียภาษี"],
  "ร้านค้า": ["id_store", "ชื่อร้านค้า", "ชื่อเต็ม", "เครดิตจ่าย", "เลขบัญชี", "ธนาคาร", "เบอร์โทร", "ที่อยู่", "เลขที่ผู้เสียภาษี"],
  "stores": ["id_store", "ชื่อร้านค้า", "ชื่อเต็ม", "เครดิตจ่าย", "เลขบัญชี", "ธนาคาร", "เบอร์โทร", "ที่อยู่", "เลขที่ผู้เสียภาษี"],
  "5. รับเหมา": ["id_Contractor", "ชื่อเล่น", "ชื่อ-นามสกุล", "ประเภท", "จำกัดยอด/ปี", "ยอดเบิกจ่ายปีนี้", "คงเหลือ", "สถานะ", "เลขบัญชี", "ธนาคาร", "บัตรประจำตัวประชาชน", "เบอร์โทรศัพท์", "ที่อยู่"],
